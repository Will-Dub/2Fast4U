...
/*
    ...
    |   after 2nd push to branch
    v
    -set pedal percent as a class member in order for it to be accessible from main to use the keyboard
    -put pedal percent back in call stack for every tick to be called using it
*/
